...
add_action('wp_enqueue_scripts', function() {
    wp_enqueue_style('pi-frontend-css', plugin_dir_url(__FILE__) . '../assets/frontend.css', [], '2.4');
    ...
    wp_enqueue_script('pi-frontend-js', plugin_dir_url(__FILE__) . '../assets/frontend.js', ['jquery', 'mapbox-gl-js'], '2.4', true);
