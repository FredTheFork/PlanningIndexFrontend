...
add_action('pmpro_checkout_preheader', function() {
    ...
    // CRITICAL FIX: Ensure jQuery is enqueued (needed for our JS)
    ...
    if (!is_user_logged_in()) {
        ...
        echo '<link rel="stylesheet" id="pmpc-trial-css-direct" href="' . esc_url($css_url) . '?v=2.0.0" type="text/css" media="all" />' . "\n";
